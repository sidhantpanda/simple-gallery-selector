package com.hashexclude.simplegalleryselector.tasks;

import android.content.AsyncTaskLoader;
import android.content.Context;

import com.hashexclude.simplegalleryselector.libraries.ImageGalleryProvider;
 ...
 */
public class ImageGalleryAsyncLoader extends AsyncTaskLoader<List<PhotoItem>> {
     ...
     * @param context
     */
    public ImageGalleryAsyncLoader(Context context) {
        super(context);
    }
    ...
    public List<PhotoItem> loadInBackground() {
        ...
        return ImageGalleryProvider.getPhotoItemsList(context);
    }
